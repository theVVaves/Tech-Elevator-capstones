<template>
  <div class="container">
    <button class="mycode" v-on:click="() => (myExample = !myExample)">My Code</button>
  <div class="myExample">
    <div class="example" v-show="myExample" v-for="example in examples" :key="example.codeId">
      <catalog-example :example="example" />
    
  <div class="public-private">
      <button class="public" v-on:click.prevent="makePublic(example.codeId, 1)">
        Make Public
      </button>
      <button class="private" v-on:click.prevent="makePublic(example.codeId, 0)">
        Make Private
      </button>
    </div>
    </div>
